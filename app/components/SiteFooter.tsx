...
export function SiteFooter() {
  return <footer className="site-footer">
    <div className="shell footer-grid">
      ...
      <div className="footer-link-group"><strong>運営方針</strong><a href="/about/">サイトについて</a><a href="/editorial-policy/">編集方針</a><a href="/sources/">参考資料</a><a href="/affiliate/">広告案件</a></div>
