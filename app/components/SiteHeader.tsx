  ...
  return <header className="site-header">
    <div className="shell header-inner">
      ...
      <nav className="desktop-nav" aria-label="主要メニュー">
        <a href="/#questions">疑問から探す</a><a href="/#science">科学で調べる</a><a href="/about/">サイトについて</a>
      </nav>
    </div>
    {menuOpen && <nav id="mobile-menu" className="mobile-nav" aria-label="モバイルメニュー">
      <a href="/#questions" onClick={closeMenu}>疑問から探す</a><a href="/#science" onClick={closeMenu}>科学で調べる</a><a href="/about/" onClick={closeMenu}>サイトについて</a><a href="/sources/" onClick={closeMenu}>参考資料</a>
    </nav>}
  </header>;
}
