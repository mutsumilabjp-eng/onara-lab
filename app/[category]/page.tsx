...
export default async function CategoryPage({ params }: CategoryPageProps) {
  ...
  return <main><SiteHeader />
    ...
    <section className="page-section"><div className="shell category-page-layout">
      <div className="category-page-intro"><span className={`category-dot ${category.tint}`}>{category.mark}</span><p>公開中の記事は、資料と表示を確認したものだけです。公開準備中のテーマは、根拠を確認してから追加します。</p></div>
